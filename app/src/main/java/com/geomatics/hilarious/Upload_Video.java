...
public class Upload_Video extends AppCompatActivity {
    ...
    public static Upload_Video ActivityContext =null;
    ...
    private static File getOutputMediaFile(int type){
        ...
        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES), "SurveyCamp");
        ...
        if (! mediaStorageDir.exists()){
            ...
            if (! mediaStorageDir.mkdirs()){
                ...
                output.setText("Failed to create directory SurveyCamp");

                Toast.makeText(ActivityContext, "Failed to create directory SurveyCamp.",
                        Toast.LENGTH_LONG).show();

                Log.d("SurveyCamp", "Failed to create directory SurveyCamp.");
                return null;
            }
        }
