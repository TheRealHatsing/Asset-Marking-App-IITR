...
public class Medical extends AppCompatActivity implements View.OnClickListener {
    ...
    //view objects
    private TextView type,textView1,textView9;
    ...
    //our new views
    private EditText editTextName, noofstaff,otherattribute1, otherattribute2, otherattribute3, otherattribute4, medium, noofrooms;
    private Button buttonSave, uploadbutton;
    private Spinner typehospital, runby, building;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noofstaff=(EditText) findViewById(R.id.noofstaff);
        noofrooms = (EditText) findViewById(R.id.noofrooms);
        buttonSave = (Button) findViewById(R.id.buttonSave);
        uploadbutton = (Button) findViewById(R.id.uploadbutton);
        getlocation = (Button) findViewById(R.id.getlocation);
        typehospital = (Spinner) findViewById(R.id.typehospitalspinner);
        type=(TextView)findViewById(R.id.type);
        runby = (Spinner) findViewById(R.id.runbytype);
    ...
    public void saveUserInformation() {
        ...
        String staff = noofstaff.getText().toString().trim();
        String Type = type.getText().toString();
        String TypeHospital = typehospital.getSelectedItem().toString().trim();
        String Runby = runby.getSelectedItem().toString();
        ...
        UserInformation userInformation = new UserInformation(name,Commercial,Powertype,Religious, rooms, teachers, staff, otherattributes1, otherattributes2, otherattributes3, otherattributes4 ,Type, TypeHospital, Runby, Building, Toilet, Electricity, Drinkingwater, Telephone,Latitude,Longitude,waterLevel,Uses,WaterType);
