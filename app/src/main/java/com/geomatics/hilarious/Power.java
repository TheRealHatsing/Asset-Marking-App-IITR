...
public class Power extends AppCompatActivity implements View.OnClickListener {
    ...
    private Spinner  powertype,runby, building, toilet,elec,dw,tele;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        powertype = (Spinner) findViewById(R.id.powertype);
    ...
    public void saveUserInformation() {
        ...
        String waterLevel = "-";
        String Uses = "-";
        String Powertype = powertype.getSelectedItem().toString();
        String Religious = "-";
        String Commercial = "-";
