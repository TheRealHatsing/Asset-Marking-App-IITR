...
public class Commercial extends AppCompatActivity implements View.OnClickListener {
    ...
    private Spinner  commercial,runby, building, toilet,elec,dw,tele;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commercial = (Spinner) findViewById(R.id.commercial);
    ...
    public void saveUserInformation() {
        ...
        String Powertype = "-";
        String Religious = "-";
        String Commercial = commercial.getSelectedItem().toString();
