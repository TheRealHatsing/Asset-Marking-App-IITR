...
public class Other extends AppCompatActivity implements View.OnClickListener {
    ...
    private Spinner  runby, building, toilet,elec,dw,tele;
    /**
    ...
    public void saveUserInformation() {
        ...
        UserInformation userInformation = new UserInformation(name,Commercial,Powertype,Religious, rooms,teachers, staff, otherattributes1, otherattributes2, otherattributes3, otherattributes4 ,Type, TypeHospital, Runby, Building, Toilet, Electricity, Drinkingwater, Telephone,Latitude,Longitude,WaterType,waterLevel,Uses);
