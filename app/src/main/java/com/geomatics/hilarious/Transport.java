...
public class Transport extends AppCompatActivity implements View.OnClickListener {
    ...
    //view objects
    private TextView textViewUserEmail, type, textView1,textView9;
    ...
    //our new views
    private EditText editTextName, otherattribute1, otherattribute2, otherattribute3, otherattribute4, nooflanes, noofrooms;
    private Button buttonSave, uploadbutton;
    private Spinner roadtype, built;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nooflanes=(EditText) findViewById(R.id.nooflanes);
        ...
        roadtype = (Spinner) findViewById(R.id.typeroadspinner);
    ...
    public void saveUserInformation() {
        ...
        String staff = nooflanes.getText().toString().trim();
        ...
        String TypeHospital = roadtype.getSelectedItem().toString();
