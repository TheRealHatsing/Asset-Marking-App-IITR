...
public class School extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        elec = (Spinner) findViewById(R.id.elec);
        dw = (Spinner) findViewById(R.id.dw);
        tele = (Spinner) findViewById(R.id.tele);
    ...
    public void saveUserInformation() {
        ...
        String teachers = noofteachers.getText().toString().trim();
        String Type = type.getSelectedItem().toString();
        String Runby = runby.getSelectedItem().toString();
        String Building = building.getSelectedItem().toString();
        String Toilet = toilet.getSelectedItem().toString();
        String Electricity = elec.getSelectedItem().toString().trim();
        String Drinkingwater = dw.getSelectedItem().toString().trim();
        String Telephone = tele.getSelectedItem().toString().trim();
