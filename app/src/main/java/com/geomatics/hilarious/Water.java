...
public class Water extends AppCompatActivity implements View.OnClickListener {
    ...
    //our new views
    private EditText editTextName,type, waterlevel,otherattribute1, otherattribute2, otherattribute3, otherattribute4, medium, noofrooms;
    private Button buttonSave, uploadbutton;
    private Spinner watertype, uses, building, toilet,elec,dw,tele;
    /**
     * ATTENTION: This was auto-generated to implement the App Indexing API.
     * See https://g.co/AppIndexing/AndroidStudio for more information.
     */
    private GoogleApiClient client;
    Intent starterIntent3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_water);
        starterIntent3 = getIntent();
        ...
        waterlevel=(EditText) findViewById(R.id.noofstaff);
        ...
        uses = (Spinner) findViewById(R.id.runbytyp);
    ...
    public void saveUserInformation() {
        ...
        String waterLevel = waterlevel.getText().toString().trim();
        String WaterType = watertype.getSelectedItem().toString();
        String Uses = uses.getSelectedItem().toString();
        String Building = "-";
        String Toilet = "-";
        String Electricity = "-";
